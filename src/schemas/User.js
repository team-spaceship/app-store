...
const UserSchema = new mongoose.Schema({
  ...
  app_ratings: [{ type: mongoose.Schema.Types.ObjectId, ref: 'VersionRating', required: false }],
  installed_apps: [{ type: mongoose.Schema.Types.ObjectId, ref: 'InstalledVersion', required: false }],
}, {
  timestamps: true,
});
